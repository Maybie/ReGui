...
ReGui.Icons = {
	...
	Audio = ArrowAsset,
	Shop = ArrowAsset,
	CharacterDance = ArrowAsset,
	Pants = ArrowAsset,
	Home = ArrowAsset,
	Robux = ArrowAsset,
	Badge = ArrowAsset,
	SpawnLocation = ArrowAsset,
	Sword = ArrowAsset,
	Clover = ArrowAsset,
	Star = ArrowAsset,
	Code = ArrowAsset,
	...
	Profile = ArrowAsset,
	Admin = ArrowAsset,
	PaintBrush = ArrowAsset,
	Speed = ArrowAsset,
	NoConnection = ArrowAsset,
	Connection = ArrowAsset,
	Globe = ArrowAsset,
	Box = ArrowAsset,
	Crown = ArrowAsset,
	Control = ArrowAsset,
	Send = ArrowAsset,
	FastForward = ArrowAsset,
	Pause = ArrowAsset,
	Reload = ArrowAsset,
	Joystick = ArrowAsset,
	Controller = ArrowAsset,
	Lock = ArrowAsset,
	Calculator = ArrowAsset,
	Sun = ArrowAsset,
	Moon = ArrowAsset,
	Prohibited = ArrowAsset,
	Flag = ArrowAsset,
	Website = ArrowAsset,
	Telegram = ArrowAsset,
	MusicNote = ArrowAsset,
	Music = ArrowAsset,
	Headphones = ArrowAsset,
	Phone = ArrowAsset,
	Smartphone = ArrowAsset,
	Desktop = ArrowAsset,
	Desktop2 = ArrowAsset,
	Laptop = ArrowAsset,
	Server = ArrowAsset,
...
function ReGui:InsertPrefab(Name: string, Properties): GuiObject
	...
	assert(Folder, "[ReGui] Missing Prefabs folder")

	local Prefabs = Folder:FindFirstChild("Prefabs") or Folder.Prefabs
	assert(Prefabs, "[ReGui] Missing Prefabs.Prefabs folder")

	local Prefab = Prefabs:FindFirstChild(Name) or Prefabs:WaitForChild(Name, 2)
	assert(Prefab, "[ReGui] Missing prefab: " .. tostring(Name))
...
ReGui:DefineElement("Window", {
	...
	Create = function(self, Config: WindowFlags)
        ...
        if not Config.NoResize then
            ResizeConnection = ReGui:MakeResizable({
